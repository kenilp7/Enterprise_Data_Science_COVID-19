...
def pd_result_large_final():
    pd_JH_data = pd.read_csv('C:/Users/kenil/Data Science/ads_covid-19/data/processed/COVID_relational_confirmed.csv', sep = ';', parse_dates = [0])
    ...
    pd_result_large.to_csv('C:/Users/kenil/Data Science/ads_covid-19/data/processed/COVID_final_set.csv',sep=';',index=False) 
